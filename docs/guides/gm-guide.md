...
The Concordat Era is a political setting first. The Force crisis, the military conflicts, the frontier survival, the espionage, the religious fracture, the economic collapse: all of these are political. They exist because people with power made choices, and those choices produced consequences that other people now live with.

This means the setting excels at genres that involve people arguing about what to do, and then living with what they decided. It struggles with genres that require the GM to present a clear moral framework and let the players operate within it. There is no clear moral framework here. Every faction has defensible positions and indefensible actions. The players will spend the campaign figuring out what they believe, not executing a plan they arrived with.
