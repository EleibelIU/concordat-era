...
- [Setting Book](docs/setting-book/setting-book.md) — The core document. 13 chapters covering the political landscape, factions, worlds, the Force crisis, and character hooks. Written from the perspective of a reasonably informed citizen of the galaxy.
